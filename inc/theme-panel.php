        ...
        <h1><?php  esc_html_e( 'Welcome to Digital Nomad', 'digital-nomad' ); ?> <?php echo esc_html( wp_get_theme()->get( 'Version' ) ); ?></h1>
			...
			<ol>
				<li><?php 
					...
					printf( esc_html__( 'Install using a child theme to avoid custom overrides lost. Learn more about child themes on <a href="%s">Wordpress.org</a>.', 'digital-nomad' ), esc_url( 'https://developer.wordpress.org/themes/advanced-topics/child-themes/' ) );
                                                                                     ?></li>
				<li><?php 
					/* translators: %s: admin url pointing to widget settings */
					printf( esc_html__( 'Under <a href="%s">Widgets</a> add menu/about text for Header sidebar. Use "Custom HTML" widget.', 'digital-nomad' ), esc_url( admin_url( 'widgets.php' ) ) ); 
                                                                                     ?></li>
				<li><?php 
					/* translators: %s: admin url pointing to theme customizer */
					printf( esc_html__( 'In <a href="%s">Customizer</a> set:', 'digital-nomad' ), esc_url( admin_url( 'customize.php?return=%2Fwp-admin%2Fthemes.php' ) ) );
                                                                                     ?>
					<ol>
