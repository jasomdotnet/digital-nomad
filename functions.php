...
if ( ! function_exists( 'digitalnomad_custom_svg_placeholder_for_header' ) ) {
    ...
    /**
     * Adds custom SVG placeholder for header using child theme
...
if ( ! function_exists( 'digitalnomad_footer_image_for_footer' ) ) {

    /**
     * Adds workflow around footer background image
     * Footer image is deffered (download on background)
     */
    function digitalnomad_footer_image_for_footer() {
...
add_action( 'wp_footer', 'digitalnomad_footer_image_for_footer', -1 );
...
if ( ! function_exists( 'digitalnomad_notitle' ) ) {
    ...
    /**
     * Returns string for post with no title
     */
